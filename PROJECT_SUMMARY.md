...
- **Нов чл. 55а:** Задължение за публичен регистър в отворен формат
- **Доп. чл. 58:** Изискване за географски координати

#### Б) В Закона за лечебните заведения
- **Доп. чл. 8:** Координати при регистрация
