...
**Оценка:** НЗОК попада в обхвата, но не изпълнява задължението.
...
**Нарушен принцип:**
ЗЕУ, чл. 7 - задължение за отворени данни
...
#### Изменение № 4: Допълнение в Приложение № 1

**Текст на предложението:**

Към списъка на масиви данни с висока стойност (Приложение № 1 към ЗЕУ) се добавя:
...
- Необходими за повторна употреба
- Съответства на EU Directive on Open Data
