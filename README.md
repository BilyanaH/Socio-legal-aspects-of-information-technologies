...
#### Изменение 1: В Наредба № 10 от 18.05.2022 г.
...
**Нов чл. 8а:**
> (1) При регистрация на лечебно заведение се посочват географските координати на адреса в координатна система WGS84.
>
> (2) Географските координати по ал. 1 се определят по ред, определен с наредба на министъра на здравеопазването.
>
> (3) Данните по ал. 1 са публични и се публикуват в Националния здравен регистър.

#### Изменение 3: Нова наредба за стандартизация на адресни данни
